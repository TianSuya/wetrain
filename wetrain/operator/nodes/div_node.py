...
class div_node(cal_node):
    ...
    def backward(self):
        ...
        #设置梯度
        self.data_1.grad += 1./self.data_2.data * self.data_3.grad
        self.data_1._node_attr['backward_type'] = 'div_backward'

        self.data_2.grad += - self.data_1.data * (1./np.power(self.data_2.data,2)) * self.data_3.grad
        self.data_2._node_attr['backward_type'] = 'div_backward'
...
if __name__ == '__main__':
    ...
    input2 = wtensor([[3,4],[6,7]])
    input3 = wtensor()
    input3.grad = [[0.1,0.1],[0.2,0.2]]

    adder = div_node(input1, input2, input3)
    adder.forward()
