...
class log_node(cal_node):
    ...
    def forward(self):
        ...
        #计算节点值
        self.data_2.data = self.log(self.data_1.data,self.a)
    ...
    def backward(self):
        ...
        #设置梯度
        self.data_1.grad += 1./(self.data_1.data * np.log(self.a)) * self.data_2.grad
...
if __name__ == '__main__':
    ...
    input2 = wtensor([[3,4],[1,2]])
    input2.grad = np.array([[0.1,0.1],[0.2,0.2]])
