...
class tanh_node(cal_node):
    ...
    def forward(self):
        ...
        #计算节点值
        self.data_2.data = np.tanh(self.data_1.data)
    ...
    def backward(self):
        ...
        #设置梯度
        self.data_1.grad += (1. - np.power(np.tanh(self.data_1.data),2)) * self.data_2.grad
...
if __name__ == '__main__':
    input1 = wtensor([[2,3],[1,2]])
    input2 = wtensor([[2,5],[3,4]])
    input2.grad += 0.4
